...
public class Game {
    ...
    public void start() throws InterruptedException {
        ...
        while (!player.isDead()) {
            ...
            if (player.getPos().getRow() == 1) {
                field.setField(new Picture(Field.PADDING + Field.CELL_SIZE, Field.PADDING, "/Users/codecadet/JavaProject/Frogger2.0/src/org/academiadecodigo/frogger/display/res/Winner.gif"));
                field.redraw();
                clip.stop();
                winSound();
                return;
        ...
        field.setField(new Picture(Field.PADDING + Field.CELL_SIZE, Field.PADDING, "/Users/codecadet/JavaProject/Frogger2.0/src/org/academiadecodigo/frogger/display/res/gameover.gif"));
        field.redraw();
        clip.stop();
        diedSound();
    }
    ...
    private void diedSound() {
        AudioInputStream audioInputStream = null;
        try {
            audioInputStream = AudioSystem.getAudioInputStream(new File("/Users/codecadet/JavaProject/Frogger2.0/resources/musics/Rafa.wav"));
        } catch (UnsupportedAudioFileException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void winSound() {
        ...
        try {
            ...
            audioInputStream = AudioSystem.getAudioInputStream(new File("/Users/codecadet/JavaProject/Frogger2.0/resources/musics/Voz_161024.wav"));
